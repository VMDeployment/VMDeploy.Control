...
Remove-Module VMDeploy.Control -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\VMDeploy.Control.psd1"
Import-Module "$PSScriptRoot\..\VMDeploy.Control.psm1" -Force
